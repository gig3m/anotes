...
// Imported as a module now rather than evaluated: the source is the same file
// the app loads, so the tests cannot drift from what ships.
const { parseDoc, docMarkdown } = await import(
  path.join(here, "..", "src", "core", "markdown.js")
)
